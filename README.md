...
Site institucional estático com Pacote Boss, Mentoria Boss, Workshop Boss, Guia de Poses e páginas dos cursos Beauty Edit, Método Boss 4P e Luz em Foco. HTML, CSS e JavaScript; não depende de bibliotecas no navegador nem de instalação de pacotes para construir o site.
